...
import { DetailInfoModalFormatter } from "../../formatters/detail-info-modal-formatter.service";
...
export class WeatherForecastComponent implements OnInit {
  ...
  openCityInfoModal() {
    ...
    this.modals.cityInfoModal.componentInstance.title =
      TEXTS.CITY_INFO_MODAL_TITLE;
  }
  ...
  openPredictionDataModal(dayIndex) {
    ...
    this.modals.predictionDataModal.componentInstance.title =
      TEXTS.PREDICTION_DATA_MODAL_TITLE;
  }
}
